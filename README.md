...
### Доказательства:
- ![Пустой список](images/error4_fix_log1.png)
- Тут мы видим, что коллекция была пуста, но на скрине ниже скрипт выкинул ошибку
- ![Ошибка](images/error4_fix_log2.png)
